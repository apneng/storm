...
<link rel="stylesheet" type="text/css"
	href="${ctx }/back/static/h-ui/css/H-ui.min.css" />
<link rel="stylesheet" type="text/css"
	href="${ctx }/back/static/h-ui.admin/css/H-ui.admin.css" />
<link rel="stylesheet" type="text/css"
	href="${ctx }/back/lib/Hui-iconfont/1.0.8/iconfont.css" />
<link rel="stylesheet" type="text/css"
	href="${ctx }/back/static/h-ui.admin/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css"
	href="${ctx }/back/static/h-ui.admin/css/style.css" />
<!--[if IE 6]>
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l">
				...
				<a href="${ctx }/userBackServlet?op=gouseradd" class="btn btn-primary radius">
					<i class="Hui-iconfont">&#xe600;</i>
						添加用户
				</a>
			</span> 
					...
					<c:forEach items="${userlist }" var="userlist">
						<tr class="text-c">
							...
							<td class="td-manage">
								...
								<a title="删除" href="${ctx }/userBackServlet?op=deluser&userid=${userlist.userId }" class="ml-5" style="text-decoration: none"><i class="Hui-iconfont">&#xe6e2;</i></a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
